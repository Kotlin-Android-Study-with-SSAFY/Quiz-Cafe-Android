...
sealed interface MainRoute : NavRoute {
    ...
    object Quiz     : MainRoute { override val route = "${Graph.route}/quiz" }
    object MyPage   : MainRoute { override val route = "${Graph.route}/mypage" }
    object Workbook : MainRoute { override val route = "${Graph.route}/workbook" }
